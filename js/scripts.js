...
function Ticket(price, ticketType) {
  this.ticketType = [];
  this.price = [];
}

Address.prototype.fullAddress = function() {
  return this.locale + ": " + this.street + ", " + this.city + ", " + this.state;
}
...
$(document).ready(function() {
  $("#add-address").click(function() {
    ...
    '<label for="new-locale">Home or Buisness:</label>' +
    '<input type="text" class="form-control new-locale">' +
    '</div>' +
    '<div class="form-group">' +
